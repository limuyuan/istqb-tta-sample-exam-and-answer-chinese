由于时间仓促和译者水平有限，许多不足之处敬请各位谅解。使用中发现问题可以直接提[Issue](https://github.com/limuyuan/istqb-tta-sample-exam-and-answer-chinese/issues/new)或者[Pull Request](https://github.com/limuyuan/istqb-tta-sample-exam-and-answer-chinese/compare)。
